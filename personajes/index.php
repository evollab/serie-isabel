...
while (($arr = fgetcsv($file, 10000, ';')) !== FALSE) {
    if ($firstLine) {
        ...
        if ($lastSeason) {
            if ((getUrl($arr[26]) . '-t3') == $characterUrl) {
                $char = $arr;
            }
        } else {
...
<html class="no-js" lang="es-ES">
    <head>
        ...
        <meta property="og:site_name" content="Mapa de personajes de la tercera temporada de la serie Isabel - Lab RTVE.es"/>
        <?php
        if (!empty($char)) { //print the url character
            if ($lastSeason) { // Third Season
                ?>
                <title>Personaje <?php print $char[26]; ?> en la serie Isabel, interpretado por <?php print $char[2]; ?> - Lab RTVE.es</title>
                <meta name="description" content="<?php print $char[2]; ?> interpreta a <?php print $char[1]; ?> en la serie Isabel. <?php print substr($char[22], 0, 100); ?>...">
                <meta name="twitter:title" content="Personaje <?php print $char[26]; ?> en la serie Isabel, interpretado por <?php print $char[2]; ?>">
                <meta name="twitter:description" content="<?php print $char[2]; ?> interpreta a <?php print $char[26]; ?> en la serie Isabel. <?php print substr($char[22], 0, 100); ?>...">
                <meta name="twitter:image" content="http://lab.rtve.es/serie-isabel/personajes/img/fotos/t3/<?php print $char[25]; ?>">
                <meta property="og:title" content="Personaje <?php print $char[26]; ?> en la serie Isabel, interpretado por <?php print $char[2]; ?>"/>
                <meta property="og:image" content="http://lab.rtve.es/serie-isabel/personajes/img/fotos/t3/<?php print $char[25]; ?>"/>
                <meta property="og:description" content="<?php print $char[2]; ?> interpreta a <?php print $char[26]; ?> en la serie Isabel. <?php print substr($char[22], 0, 100); ?>..."/>
                <meta property="og:url" content="http://lab.rtve.es/serie-isabel/personajes/personaje/<?php print getUrl($char[26]); ?>-t3"/>
                <?php
            } else {
                ?>
            ...
            <meta name="twitter:title" content="Mapa de personajes de la tercera temporada de la serie Isabel - Lab RTVE.es">
            ...
            <meta property="og:title" content="Mapa de personajes de la tercera temporada de la serie Isabel - Lab RTVE.es"/>
            ...
            <meta property="og:url" content="http://lab.rtve.es/serie-isabel/personajes/"/>
            <?php
        } //end if
        ?>
        ...
        ?>
                <article style="clear: both; float: left; ">
                    <?php if (strlen($char[17])): ?>
                        <img src="/serie-isabel/personajes/img/fotos/t3/<?php print $char[25]; ?>" alt="<?php print $char[26]; ?>" title="Fotografía de <?php print $char[26]; ?> en la serie Isabel">
                    <?php endif; ?>
                    <h1>
    ...
    <header id="lab-header" class="clearfix">
        ...
        <div class="social-lockup">
            ...
            <a class="social-twitter"  target="_blank" style="display: block;" href="https://twitter.com/intent/tweet?button_hashtag=lab_rtvees&amp;via=lab_rtvees&amp;text=Mapa de personajes de la tercera temporada de la serie Isabel http://lab.rtve.es/serie-isabel/personajes/" data-lang="es" data-related="lab_rtvees" data-url="http://lab.rtve.es/serie-isabel/personajes/" via="lab_rtvees"></a>
        </div>
    </header>
    <nav id="isabel-menu">
        ...
        <ul class="wk-col-l isb-links">
            ...
            <li ng-show="!status.lastSeason"><a target="_self" href="http://lab.rtve.es/serie-isabel/rendicion-de-granada" title="Comienza la segunda temporada de Isabel">La rendición de granada</a></li>
        ...
        <main id="main">
            <div class="main-wrap">
                <nav id="legend-season3-topleft">
                    ...
                    <div class="wk-col-l" style="padding: 20px 0px 20px 0; clear: left"></div>
                    ...
                    <div class="wk-col-l" style="padding: 20px 10px 20px 0; clear: left">Filtrar por</div>
                    <a prevent-def href="#" hm-tap="fns.interact.toggleChaptStats()" ng-click="fns.interact.toggleChaptStats()" id="toggle-chapter-stats" class="pastSeasonSlide bl-toggler wk-col-l {{status.staticsChapt && 'dcha'|| ''}}"
                       title="Alterna entre la visualización de reinos y capítulos" style="display:none;">
                        <span class="wk-col-l {{!status.staticsChapt && 'act'|| ''}}">Relaciones</span>
                        <span class="wk-col-r {{status.staticsChapt && 'act'|| ''}}">Apariciones</span>
                    </a>
                    <a prevent-def href="#" hm-tap="fns.interact.toggleChaptStats()" ng-click="fns.interact.toggleChaptStats()" id="toggle-chapter-stats3" class="lastSeasonSlide bl-toggler wk-col-l {{status.staticsChapt3 && 'dcha'|| ''}}"
                       title="Alterna entre la visualización de reinos y capítulos">
                        <span class="wk-col-l {{!status.staticsChapt3 && 'act'|| ''}}">Relaciones</span>
                        <span class="wk-col-r {{status.staticsChapt3 && 'act'|| ''}}">Apariciones</span>
                    </a>
                </nav>                
                <section ng-show="!status.lastSeason" class="pastSeason char-tree {{status.charTreeHover && 'char-tree-hover'|| ''}}
                    ...
                    <div class="char-tree-wrap">
                        ...
                        <div id="sferas-main">
                            <div ng-repeat="personaje in personajes| filter: fns.interact.basicCharFiltro" 
                                 class="bl-char-circ char-{{personaje.id}} bl-char-circ-cor-{{personaje.esferacoronas}}
                                 ...
                                 ng-mouseenter="fns.interact.activateSfera(personaje)" ng-mouseout="fns.interact.clearActiveSfera(personaje)"
                ...
                <section ng-cloak id="char-data" class="{{(status.activeSfera && !status.lastSeason) && 'act'|| ''}}">
                    ...
                    <div class="char-srch-wrap">
                        ...
                        <div class="bl-characters">
                            <div ng-repeat="personaje in personajes| orderBy: 'PERSONAJE' | filter: fns.search.filters" 
                                 class="wk-col-l bl-char" hm-tap="fns.interact.chooseTempCharacter(personaje)" ng-click="fns.interact.chooseTempCharacter(personaje)">
                                <img ng-src="{{fns.interact.chooseImageCharacter(personaje)}}" height="160" width="130" alt="Imagen de {{fns.interact.chooseNameCharacter(personaje)}}">
                                <div class="char-srch-text">
                                    <p>{{fns.interact.chooseNameCharacter(personaje)}}</p>
                ...
                <section id="season-3-wrapper" ng-show="status.lastSeason" class="lastSeason char-tree {{status.lastSeason && 'last-season'|| ''}} 
                         {{(status.statics|| status.staticsChapt3) && 'char-tree-noborder' || ''}}">
                    <div id="legend-topright-season3">
                        <!-- hidden statics -->                        
                        <div class="legend-block-season3">
                            <table>
                                <tbody>
                                    <tr>
                                        <td class="circle">
                                            <svg height="20" width="20">
                                            <circle cx="10" cy="10" r="6" stroke="#DE0738" stroke-width="1" fill="#DD1442" />
                                            </svg>

                                        </td>
                                        <td>
                                            <strong>Castilla</strong>
                                        </td>
                                        <td class="circle">
                                            <svg height="18" width="18">
                                            <circle cx="10" cy="10" r="6" stroke="#01A7C1" stroke-width="1" fill="#01A7C1" />
                                            </svg>
                                    ...
                                    <tr>
                                        <td class="circle">
                                            <svg height="18" width="18">
                                            <circle cx="10" cy="10" r="6" stroke="#FCC82B" stroke-width="1" fill="#FCC82B" />
                                            </svg>
                                        ...
                                        <td class="circle">
                                            <svg height="18" width="18">
                                            <circle cx="10" cy="10" r="6" stroke="#6D9965" stroke-width="1" fill="#6D9965" />
                                            </svg>
                                    ...
                                    <tr>
                                        <td class="circle">
                                            <svg height="18" width="18">
                                            <circle cx="10" cy="10" r="6" stroke="#AB79B8" stroke-width="1" fill="#AB79B8" />
                                            </svg>

                                        </td>
                                        <td>
                                            <strong>Vaticano</strong>
                                        </td>
                                        <td class="circle">
                                            <svg height="18" width="18">
                                            <circle cx="10" cy="10" r="6" stroke="#F07FCC" stroke-width="1" fill="#F07FCC" />                                            
                                            </svg>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>Familia</td>
                                        <td colspan="2"><svg width="95" height="15">
                                            <path fill="none" stroke="#555" d="M0,7L93,7" stroke-width="4" style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path>
                                            </svg></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td>Aliados</td>
                                        <td colspan="2"><svg width="95" height="15">
                                            <path fill="none" stroke="#555" d="M0,7L93,7" stroke-width="4" style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);stroke-dasharray: 12px, 4px;"></path>
                                            </svg></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td>Enemigos</td>
                                        <td colspan="2"><svg width="95" height="15">
                                            <path fill="none" stroke="#555" d="M0,7L93,7" stroke-width="4" style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);stroke-dasharray: 4px, 4px;"></path>
                                            </svg></td>
                                    </tr>                                    
                                </tbody>
                            </table>
                    ...
                    <div id="third-season-charter-wrapper">
                        <!-- dibujo svg de estadísticas capitulos-->
                        <div id="sferas-raphaelstatics-chaps3" ng-show="status.staticsChapt3"></div>

                        <div id="sferas-raphael-season-3"></div>
                        <div ng-repeat="personaje in personajes| filter: fns.interact.basicCharFiltro"  
                             class="bl-char-circ char-{{personaje.id}} bl-char-circ-lev{{personaje.esferalevels3}} bl-char-circ-cor-{{personaje.esferacoronas3}}
                             {{(personaje.actSfera|| status.activeSfera.id == personaje.id) && 'act-sfera' || ''}}
                             {{(status.activeSfera.id == personaje.id) && 'main-sfera act-sfera' || ''}}
                             {{(status.charTreeHover.id == personaje.id) && 'act-sfera' || ''}}"
                             ng-mouseenter="fns.interact.activateSferaSeason3(personaje)" ng-mouseout="fns.interact.clearActiveSferaSeason3(personaje)"
                             hm-tap="fns.interact.activateSfera(personaje)" hm-doubletap="fns.interact.clickSferaSeason3(personaje)" ng-click="fns.interact.clickSferaSeason3(personaje)">
                            <div class="bl-char-img">
                                <img ng-src="/serie-isabel/personajes/img/fotos/t3/{{personaje.IMAGENES3}}" height="100" width="100" alt="Imagen de {{personaje.PERSONAJE3}}">
                            </div>
                            <h2>{{personaje.PERSONAJE3}}</h2>
                        </div>
                    </div>                                           
                </section>
                <!-- ficha de personajes temporada 3 -->
                <section ng-cloak id="char-data-season-3" class="{{(status.activeSfera && status.lastSeason) && 'act' || ''}}">
                    <div class="char-data-wrap">
                        <!-- bloque izquierdo de relaciones -->
                        <div class="sferas-info">
                            <!-- relaciones: familia -->
                            <div class="sfera-famili clearfix">
                                <h3 ng-show="status.activeSfera.sferasRel3.f.length">Familia:</h3>
                                <a href="#" prevent-def ng-repeat="rel in status.activeSfera.sferasRel3.f" title="{{rel.PERSONAJE3}}"
                                   class="wk-col-l bl-char bl-char-rel bl-char-circ-lev3 bl-char-circ-cor-{{rel.esferacoronas3}}" hm-tap="fns.interact.clickSferaSeason3(rel)" ng-click="fns.interact.clickSferaSeason3(rel)">
                                    <div class="bl-char-img">
                                        <img ng-src="/serie-isabel/personajes/img/fotos/t3/{{rel.IMAGENES3}}" height="160" width="130" alt="Imagen de {{rel.PERSONAJE3}}">
                                    </div>
                                </a>
                            </div>
                            <!-- relaciones: aliados -->
                            <div class="sfera-friends clearfix">
                                <h3 ng-show="status.activeSfera.sferasRel3.a.length">Aliados:</h3>
                                <a href="#" prevent-def ng-repeat="rel in status.activeSfera.sferasRel3.a" title="{{rel.PERSONAJE3}}"
                                   class="wk-col-l bl-char bl-char-rel bl-char-circ-lev3 bl-char-circ-cor-{{rel.esferacoronas3}}" hm-tap="fns.interact.clickSferaSeason3(rel)" ng-click="fns.interact.clickSferaSeason3(rel)">
                                    <div class="bl-char-img">
                                        <img ng-src="/serie-isabel/personajes/img/fotos/t3/{{rel.IMAGENES3}}" height="160" width="130" alt="Imagen de {{rel.PERSONAJE3}}">
                                    </div>
                            ...
                            <!-- relaciones: enemigos -->
                            <div class="sfera-enemis clearfix">
                                <h3 ng-show="status.activeSfera.sferasRel3.e.length">Enemigos:</h3>
                                <a href="#" prevent-def ng-repeat="rel in status.activeSfera.sferasRel3.e" title="{{rel.PERSONAJE3}}"
                                   class="wk-col-l bl-char bl-char-rel bl-char-circ-lev3 bl-char-circ-cor-{{rel.esferacoronas3}}" hm-tap="fns.interact.clickSferaSeason3(rel)" ng-click="fns.interact.clickSferaSeason3(rel)">
                                    <div class="bl-char-img">
                                        <img ng-src="/serie-isabel/personajes/img/fotos/t3/{{rel.IMAGENES3}}" height="160" width="130" alt="Imagen de {{rel.PERSONAJE3}}">
                                    </div>
                        ...
                        <div class="char-info">
                            <a prevent-def href="#" hm-tap="fns.interact.clickClearSfera()" ng-click="fns.interact.clickClearSfera()" class="wk-col-r sferas-info-close">Cerrar</a>
                            <h2>{{status.activeSfera.PERSONAJE3}}</h2>
                            <div class="wk-col-r social-links">
                                <a class="social-fbook wk-col-r" href="http://www.facebook.com/sharer.php?u=http://lab.rtve.es/serie-isabel/personajes/personaje/{{status.activeSfera.safeUrl3}}-t3" target="_blank">Hacer like al personaje en Facebook</a>
                                <a class="social-twitter wk-col-r" href="https://twitter.com/intent/tweet?button_hashtag=lab_rtvees&amp;via=lab_rtvees&amp;text={{status.activeSfera.PERSONAJE3}} en Isabel, la serie http://lab.rtve.es/serie-isabel/personajes/personaje/{{status.activeSfera.safeUrl3}}-t3" data-lang="es" data-related="lab_rtvees" data-url="/serie-isabel/personajes/personajes/{{status.activeSfera.safeUrl3}}-t3" via="lab_rtvees" target="_blank">Twittear al personaje</a>
                            </div>
                            <h3>{{status.activeSfera.SubTitle3}}</h3>
                            <a ng-hide="!status.activeSfera.LINKS" ng-href="{{status.activeSfera.LINKS}}" target="_blank" class="wk-col-r sferas-info-link">Ver ficha completa</a>
                            <p ng-hide="!status.activeSfera.ACTORES" style="color: #bd1b42">Interpretado por {{status.activeSfera.ACTORES}}</p>
                            <div ng-bind-html-unsafe="status.activeSfera.Body3 | paragraphFix"></div>
                        </div>
                    </div>
                </section>
            </div>
